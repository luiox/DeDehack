package me.caiyudu.dedehack.util.render;
...
public final class RenderUtil
{
    ...
    public static void drawPlane(AxisAlignedBB axidedeignedbb, float width, int color)
    {
        GlStateManager.pushMatrix();
        ...
        glEnable(GL_LINE_SMOOTH);
        glHint(GL_LINE_SMOOTH_HINT, GL_NICEST);
        drawPlane(axidedeignedbb, color);
        glDisable(GL_LINE_SMOOTH);
        GlStateManager.depthMask(true);
        GlStateManager.enableDepth();
        GlStateManager.enableTexture2D();
    ...
    public static float drawStringWithShadow(String p_Name, float p_X, float p_Y, int p_Color)
    {
        ...
        return DeDeHack.GetFontManager().DrawStringWithShadow(p_Name, p_X, p_Y, p_Color);
    }
    ...
    public static float getStringWidth(String p_Name)
    {
        ...
        return DeDeHack.GetFontManager().GetStringWidth(p_Name);
    }
    ...
    public static float getStringHeight(String name)
    {
        ...
        return DeDeHack.GetFontManager().GetStringHeight(name);
    }

    public static void drawSplitString(String p_Name, int p_X, int p_Y, int p_K, int p_Color)
    {
        /*
         * final HudModule l_Hud = (HudModule) DeDeHack.INSTANCE.getModuleManager().find(HudModule.class);
         * 
         ...
         * GL11.glHint(GL11.GL_POINT_SMOOTH_HINT, GL11.GL_NICEST); GL11.glDepthMask(false); DeDeHack.INSTANCE.customFont.drawSplitString(p_Name, p_X, p_Y, p_K, p_Color);
    ...
    public static void drawColorBox(AxisAlignedBB axidedeignedbb, float red, float green, float blue, float alpha)
    {
        Tessellator ts = Tessellator.getInstance();
        BufferBuilder vb = ts.getBuffer();
        vb.begin(7, DefaultVertexFormats.POSITION_TEX);// Starts X.
        vb.pos(axidedeignedbb.minX, axidedeignedbb.minY, axidedeignedbb.minZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.maxY, axidedeignedbb.minZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.minY, axidedeignedbb.minZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.maxY, axidedeignedbb.minZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.minY, axidedeignedbb.maxZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.maxY, axidedeignedbb.maxZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.minY, axidedeignedbb.maxZ).color(red, green, blue, alpha).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.maxY, axidedeignedbb.maxZ).color(red, green, blue, alpha).endVertex();
        ts.draw();
    ...
    public static void drawColorBox(AxisAlignedBB axidedeignedbb, Color c)
    {
        Tessellator ts = Tessellator.getInstance();
        BufferBuilder vb = ts.getBuffer();
        vb.begin(7, DefaultVertexFormats.POSITION_TEX);// Starts X.
        vb.pos(axidedeignedbb.minX, axidedeignedbb.minY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.maxY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.minY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.maxY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.minY, axidedeignedbb.maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.maxY, axidedeignedbb.maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.minY, axidedeignedbb.maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.minX, axidedeignedbb.maxY, axidedeignedbb.maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        ts.draw();
        vb.begin(7, DefaultVertexFormats.POSITION_TEX);
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.maxY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
        vb.pos(axidedeignedbb.maxX, axidedeignedbb.minY, axidedeignedbb.minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
