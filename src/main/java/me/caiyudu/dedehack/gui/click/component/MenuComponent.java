package me.caiyudu.dedehack.gui.click.component;
...
import me.caiyudu.dedehack.util.render.AbstractGui;
...
public class MenuComponent
{
    ...
    public boolean Render(int p_MouseX, int p_MouseY, boolean p_CanHover, boolean p_AllowsOverflow, float p_OffsetY)
    {
        ...
        if (BarTexture != null)
        {
            ...
            //DeDeHack.INSTANCE.logChat("Opacity is " + Opacity);            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0FF);
