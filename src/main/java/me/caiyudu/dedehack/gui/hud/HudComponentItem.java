package me.caiyudu.dedehack.gui.hud;
...
public class HudComponentItem
{
    ...
    {
        File l_Exists = new File("DeDeHack/HUD/" + GetDisplayName() + ".json");
        if (!l_Exists.exists())
            return;
        ...
        try 
        {
            ...
            // create a reader
            Reader reader = Files.newBufferedReader(Paths.get("DeDeHack/HUD/" + GetDisplayName() + ".json"));
