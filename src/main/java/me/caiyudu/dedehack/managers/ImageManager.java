...
public class ImageManager
{
    ...
    public void LoadImage(String p_Img)
    {
        ...
        InputStream l_Stream = ImageManager.class.getResourceAsStream("/assets/dedehack/imgs/" + p_Img + ".png");
        ...
        if (l_Texture != null)
        {
            l_Texture.SetResourceLocation(Minecraft.getMinecraft().getTextureManager()
                    .getDynamicTextureLocation("dedehack/textures", l_Texture));
    ...
    {
        return DeDeHack.GetImageManager();
    }
