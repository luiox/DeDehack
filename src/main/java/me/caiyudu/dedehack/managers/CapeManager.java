...
public class CapeManager implements Listenable
{
    ...
    public void LoadCapes()
    {
        try
        {
            ...
            l_URL = new URL("https://raw.githubusercontent.com/Orb924/dedehack-assets/master/assets/capes/cape.txt");
            ...
            l_URL = new URL("https://raw.githubusercontent.com/Orb924/dedehack-assets/master/assets/capes/capes.txt");
            l_Connection = l_URL.openConnection();
            l_Connection.setRequestProperty("User-Agent",
                    "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.29 Safari/537.36");
    ...
    public void DownloadCapeFromLocationWithName(String p_Link, String p_Name) throws MalformedURLException, IOException
    {
        ...
        Capes.put(p_Name, Wrapper.GetMC().getTextureManager().getDynamicTextureLocation("dedehack/capes", l_Texture));
    }
    ...
    {
        return DeDeHack.GetCapeManager();
    }
}
