...
public class HudManager
{
    ...
    public void ScheduleSave(HudComponentItem p_Item)
    {
        ...
        try
        {
            ...
            Writer writer = Files.newBufferedWriter(Paths.get("DeDeHack/HUD/" + p_Item.GetDisplayName() + ".json"));
