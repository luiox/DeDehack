package me.caiyudu.dedehack.module.chat;

import me.caiyudu.dedehack.events.player.EventPlayerSendChatMessage;
...
public class MessageModifierModule extends Module{
    ...
    public String setSuffix = "dedehack";
    ...
    private final Listener<EventPlayerSendChatMessage> OnSendChatMsg = new Listener<>(p_Event ->
    {
       ...
       if(FancyChat.getValue()) {
        ...
        //FancyChatMode.getValue() != FancyChatModes.UwU ? suffix = "dedehack";
