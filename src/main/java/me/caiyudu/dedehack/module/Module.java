package me.caiyudu.dedehack.module;
...
import me.caiyudu.dedehack.managers.CommandManager;
...
{ 
    ...
    public void onEnable()
    {
        ...
        DeDeHackMod.EVENT_BUS.post(new EventDeDeHackModuleEnable(this));
    }

    public void onDisable()
    {
        /// didedelow events to be called
        DeDeHackMod.EVENT_BUS.unsubscribe(this);
        DeDeHackMod.EVENT_BUS.post(new EventDeDeHackModuleDisable(this));
    }
    ...
    {
        COMBAT, EXPLOIT, MOVEMENT, RENDER, WORLD, MISC, HIDDEN, UI, BOT, SCHEMATICA, CHAT
    }
    ...
    {
        if (mc.player != null)
            DeDeHack.SendMessage(ChatFormatting.AQUA + "[" + GetArrayListDisplayName() + "]: " + ChatFormatting.RESET + p_Message);
    }
