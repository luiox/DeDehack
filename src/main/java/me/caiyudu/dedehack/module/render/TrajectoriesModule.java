...
/**
 * A feature that projects the possible path of an entity that was fired. Throwables in this game use randomness to come up with a path that is <b>never</b> the same using {@link java.util.Random}.
 * <p>
 * This results in <b>perfect</b> predictions when disregarding the randomness in the trajectory.
 * <p>
