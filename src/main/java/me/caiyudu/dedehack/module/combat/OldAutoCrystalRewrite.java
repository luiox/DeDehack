...
public class OldAutoCrystalRewrite extends Module{
    ...
    public OldAutoCrystalRewrite()
    {
        super("OldAutoCrystalRewrite", new String[] {"AutoCrystal3"}, "DeDehack's 2.04.3 AutoCrystalRewrite.", "NONE", -1, Module.ModuleType.COMBAT);
    }

    private static OldAutoCrystalRewrite Mod = null;
