...
import me.caiyudu.dedehack.managers.DiscordManager;
...
import me.caiyudu.dedehack.module.combat.AutoCrystalRewrite;
import me.caiyudu.dedehack.module.combat.OldAutoCrystalRewrite;
...
public class DiscordRPCModule extends Module
{
    ...
    public final Value<Boolean> Ionar = new Value<Boolean>("Ionar", new String[] {"U"}, "Displays a message about caiyudu", true);
    ...
    public String generateState()
    {
        ...
        if (Ionar.getValue())
        {
            return "Thank you Ionar for DeDeHack!";
        }

        if (GitHub.getValue())
        {
            return "The Orb924 DeDeHack source is hosted at https://github.com/Orb924/dedehack!";
        }
        ...
        if (Crystalling.getValue() && _autoCrystal.isEnabled() && _autoCrystal.getTarget() != null || _oldAutoCrystal.isEnabled())
            return "Crystalling " + _autoCrystal.getTarget() + " with DeDeHack's autocrystal!";
