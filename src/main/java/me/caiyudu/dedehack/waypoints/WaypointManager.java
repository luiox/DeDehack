package me.caiyudu.dedehack.waypoints;
...
import me.caiyudu.dedehack.module.render.WaypointsModule;
import me.caiyudu.dedehack.util.SalVec3d;
import me.caiyudu.dedehack.waypoints.Waypoint.Type;
...
public class WaypointManager implements Listenable
{
    public WaypointManager()
    {
        ...
        try 
        {
            ...
            Reader reader = Files.newBufferedReader(Paths.get("DeDeHack/Waypoints/Waypoints.json"));
    ...
    {
        return DeDeHack.GetWaypointManager();
    }
    ...
    private void ProcessSave()
    {
        try
        {
            ...
            Writer writer = Files.newBufferedWriter(Paths.get("DeDeHack/Waypoints/Waypoints.json"));
