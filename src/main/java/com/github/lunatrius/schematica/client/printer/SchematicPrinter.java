...
import me.caiyudu.dedehack.module.exploit.LiquidInteractModule;
...
public class SchematicPrinter
{
    ...
    private boolean Statcaiyuduy = false;
    ...
    public boolean IsStatcaiyuduy()
    {
        return schematic == null || Statcaiyuduy;
    }
   ...
   //     this.isPrinting = false;
    ...
    private boolean placeBlock(final WorldClient world, final EntityPlayerSP player, final BlockPos pos, final IBlockState blockState, final ItemStack itemStack)
    {
        ...
        DeDeHackMod.EVENT_BUS.post(new EventSchematicaPlaceBlock(pos));
        ...
        if (itemStack != null)
        {
            ...
            if (player.inventory.getStackInSlot(l_Slot).getItem() == itemStack.getItem())
            {
             ...
             //   DeDeHack.SendMessage("Switching to slot: " + l_Slot);
            }
        }
