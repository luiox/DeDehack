...
public class BlurConfigGui extends GuiConfig {
    ...
    public BlurConfigGui(GuiScreen parentScreen) {
        super(parentScreen, new ConfigElement(DeDeHackMod.instance.config.getCategory(Configuration.CATEGORY_GENERAL)).getChildElements(), DeDeHackMod.NAME, false, false, I18n.format("DeDeHack_blur" + ".config.title"));
    }
